<?php
/**
 * PreparedEnvelopeParsedContentEmailNotifications
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PreparedEnvelopeParsedContentEmailNotifications Class Doc Comment
 *
 * @category Class
 * @package  Nmusco\AssureSign\v3
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PreparedEnvelopeParsedContentEmailNotifications implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'preparedEnvelopeParsed_content_emailNotifications';
     ...
     * Sets custom_message
     *
     * @param string|null $custom_message Specifies a custom message to add at the end of the email notification
     *
     * @return $this
     */
