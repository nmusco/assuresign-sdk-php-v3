...
class SsoResultDto implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['ssoToken'] = isset($data['ssoToken']) ? $data['ssoToken'] : null;
    }
    ...
    {
        return $this->container['ssoToken'];
    }

    /**
     * Sets ssoToken
     *
     * @param string|null $ssoToken ssoToken
     *
     * @return $this
     */
    public function setSsoToken($ssoToken)
    {
        $this->container['ssoToken'] = $ssoToken;
