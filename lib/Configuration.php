...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://sb.assuresign.net/api/documentnow/v3.6';
    ...
    {
        $report  = 'PHP SDK (Nmusco\AssureSign\v3) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 3.6' . PHP_EOL;
