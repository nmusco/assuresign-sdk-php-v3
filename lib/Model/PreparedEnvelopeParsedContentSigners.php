<?php
/**
 * PreparedEnvelopeParsedContentSigners
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PreparedEnvelopeParsedContentSigners Class Doc Comment
 *
 * @category Class
 * @package  Nmusco\AssureSign\v3
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PreparedEnvelopeParsedContentSigners implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'preparedEnvelopeParsed_content_signers';
    ...
    protected static $openAPITypes = [
        ...
        'enable_kba' => 'bool',
        'kba' => '\Nmusco\AssureSign\v3\Model\PreparedEnvelopeParsedContentKba'
    ];
     ...
     * Sets sms_auth_phone
     *
     * @param string|null $sms_auth_phone Specifies the phone number that SMS Two-Factor authentication should use to authenticate the signer for signing or envelope downloads.
     *
     * @return $this
     */
     ...
     * Sets enable_kba
     *
     * @param bool|null $enable_kba When set to true, KBA property must be populated
     *
     * @return $this
     */
     ...
     * Gets kba
     *
     * @return \Nmusco\AssureSign\v3\Model\PreparedEnvelopeParsedContentKba|null
     */
     ...
     * Sets kba
     *
     * @param \Nmusco\AssureSign\v3\Model\PreparedEnvelopeParsedContentKba|null $kba kba
     *
     * @return $this
     */
