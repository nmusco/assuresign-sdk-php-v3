<?php
/**
 * PreparedEnvelopeParsedContentFontDecoration
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PreparedEnvelopeParsedContentFontDecoration Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PreparedEnvelopeParsedContentFontDecoration implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'preparedEnvelopeParsed_content_fontDecoration';
     ...
     * Sets bold
     *
     * @param bool|null $bold Specifies whether or not text content for the field will be rendered in Bold.
     *
     * @return $this
     */
     ...
     * Sets italic
     *
     * @param bool|null $italic Specifies whether or not text content for the field will be rendered in Italics.
     *
     * @return $this
     */
     ...
     * Sets underline
     *
     * @param bool|null $underline Specifies whether or not text content for the field will be underlined.
     *
     * @return $this
     */
