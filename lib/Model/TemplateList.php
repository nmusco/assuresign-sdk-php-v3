...
class TemplateList implements ModelInterface, ArrayAccess
{
     ...
     * Gets templates
     *
     * @return \Nmusco\AssureSign\v3\Model\Template[]
     */
     ...
     * Sets templates
     *
     * @param \Nmusco\AssureSign\v3\Model\Template[] $templates Provides a list of the templates accessible to the current user.
     *
     * @return $this
     */
