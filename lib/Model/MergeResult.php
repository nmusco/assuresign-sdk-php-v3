...
class MergeResult implements ModelInterface, ArrayAccess
{
     ...
     * Sets result
     *
     * @param string|null $result Provides the resulting merged object.
     *
     * @return $this
     */
     ...
     * Sets trace
     *
     * @param string|null $trace Provides a list of the merge operations that were applied to the object.
     *
     * @return $this
     */
