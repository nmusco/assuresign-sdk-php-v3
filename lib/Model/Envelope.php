...
class Envelope implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'workflowType' => 'string',
        'allowInPersonSigning' => 'bool',
        'redirectUrl' => 'string',
        'termsAndConditions' => '\Nmusco\AssureSign\v3\Model\TermsAndConditions'
    ];
    ...
    protected static $attributeMap = [
        ...
        'allowInPersonSigning' => 'allowInPersonSigning',
    ...
    protected static $setters = [
        ...
        'allowInPersonSigning' => 'setAllowInPersonSigning',
    ...
    protected static $getters = [
        ...
        'allowInPersonSigning' => 'getAllowInPersonSigning',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['allowInPersonSigning'] = isset($data['allowInPersonSigning']) ? $data['allowInPersonSigning'] : null;
    ...
    /**
     * Gets allowInPersonSigning
     *
     * @return bool|null
     */
    public function getAllowInPersonSigning()
    {
        return $this->container['allowInPersonSigning'];
    }

    /**
     * Sets allowInPersonSigning
     *
     * @param bool|null $allowInPersonSigning Specifies whether or not in person signing should be enabled for the envelope.
     *
     * @return $this
     */
    public function setAllowInPersonSigning($allowInPersonSigning)
    {
        $this->container['allowInPersonSigning'] = $allowInPersonSigning;
     ...
     * Sets redirectUrl
     *
     * @param string|null $redirectUrl Optionally specifies a fully qualified domain name that signers will be redirected to after signing when they have no other documents in the envelope they can currently sign. If a URL is specified here, it will supersede any other redirect URLs specified elsewhere in the application (such as a default account redirect URL)
     *
     * @return $this
     */
     ...
     *
     * @return \Nmusco\AssureSign\v3\Model\TermsAndConditions|null
     */
     ...
     *
     * @param \Nmusco\AssureSign\v3\Model\TermsAndConditions|null $termsAndConditions termsAndConditions
     *
     * @return $this
     */
