...
class SubmissionWebHook implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'submissionWebHook';
...
self::TIMING_ON_ENVELOPE_LANDING_VISIT,        ];
     ...
     * Sets design_name
     *
     * @param string $design_name Specifies the design name of the webhook.
     *
     * @return $this
     */
     ...
     * Sets timing
     *
     * @param string $timing Specifies the stage in the envelope signing process during which the webhook will be executed.
     *
     * @return $this
     */
     ...
     * Sets step
     *
     * @param int $step Specifies the 0-based index of the signing step with which the webhook is associated (StepStart, StepComplete)
     *
     * @return $this
     */
