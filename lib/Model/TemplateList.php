...
class TemplateList implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'templates' => '\Nmusco\AssureSign\v3\Model\Template[]'
    ];
     ...
     * Gets templates
     *
     * @return \Nmusco\AssureSign\v3\Model\Template[]|null
     */
     ...
     * Sets templates
     *
     * @param \Nmusco\AssureSign\v3\Model\Template[]|null $templates Provides a list of the templates accessible to the current user.
     *
     * @return $this
     */
