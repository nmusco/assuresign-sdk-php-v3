...
class WorkflowStepDelay implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'workflowStepDelay';
...
'hours' => 'getHours'    ];
     ...
     * Sets days
     *
     * @param int $days The number of days the step will be delayed.
     *
     * @return $this
     */
     ...
     * Sets hours
     *
     * @param int $hours The number of hours the step will be delayed.
     *
     * @return $this
     */
