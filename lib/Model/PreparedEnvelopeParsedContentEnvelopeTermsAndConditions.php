<?php
/**
 * PreparedEnvelopeParsedContentEnvelopeTermsAndConditions
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PreparedEnvelopeParsedContentEnvelopeTermsAndConditions Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PreparedEnvelopeParsedContentEnvelopeTermsAndConditions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'preparedEnvelopeParsed_content_envelope_termsAndConditions';
     ...
     *
     * @param string|null $additional_compliance_statement Optional information that will be appended to any default system or account terms.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $additional_agreement_statement Optional information that will be appended to any default system or account agreement terms.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $additional_extended_disclosures Optional information that will be appended to any default system or account disclosures terms.
     *
     * @return $this
     */
