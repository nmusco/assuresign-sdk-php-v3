...
self::STAGE_ON_ENVELOPE_LANDING_VISIT,        ];
     ...
     * Sets custom_message
     *
     * @param string $custom_message Specifies a custom message to add at the end of the email notification
     *
     * @return $this
     */
     ...
     *
     * @param int $pre_expiration_days Specifies the the amount of days to send a pre-expiration notification. (only applicable to Pre-Expire)
     *
     * @return $this
     */
