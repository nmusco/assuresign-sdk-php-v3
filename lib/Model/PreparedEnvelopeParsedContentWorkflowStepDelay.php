<?php
/**
 * PreparedEnvelopeParsedContentWorkflowStepDelay
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PreparedEnvelopeParsedContentWorkflowStepDelay Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PreparedEnvelopeParsedContentWorkflowStepDelay implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'preparedEnvelopeParsed_content_workflowStepDelay';
     ...
     * Sets days
     *
     * @param int|null $days The number of days the step will be delayed.
     *
     * @return $this
     */
     ...
     * Sets hours
     *
     * @param int|null $hours The number of hours the step will be delayed.
     *
     * @return $this
     */
