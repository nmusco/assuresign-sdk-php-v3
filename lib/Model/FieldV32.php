...
class FieldV32 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fieldV3_2';
...
self::FORMATTER_TYPE_CUSTOM,        ];
     ...
     * Sets border_sides
     *
     * @param int $border_sides Specifies the borders that should be drawn around the field (if any) as integer representation of a bitwise operator.  For Example: None = 0, Top = 1, Right = 2, Bottom = 4, Left = 8, All = 15
     *
     * @return $this
     */
     ...
     * Sets certified
     *
     * @param bool $certified Specifies whether or not printed metadata uniquely identifying the field should be rendered around it to visually distinguish it from other data on the containing page.
     *
     * @return $this
     */
     ...
     * Sets field_type
     *
     * @param string $field_type Specifies the type of input required for the field: signature/initials or text.
     *
     * @return $this
     */
     ...
     * Sets input_type
     *
     * @param string $input_type Specifies the source of the input for the field.  Possible values include &apos;Signer&apos; and &apos;Fixed&apos;.
     *
     * @return $this
     */
     ...
     * Sets instructions
     *
     * @param string $instructions Specifies the instructions that will be presented to the signer when they are prompted to provide input for the field.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Specifies the name of the field.
     *
     * @return $this
     */
     ...
     * Sets required
     *
     * @param bool $required Specifies whether or not signer input is required for the field.
     *
     * @return $this
     */
     ...
     * Sets signer
     *
     * @param string $signer Specifies the label identifying the intended signer for fields that require signer input (signature or text).
     *
     * @return $this
     */
     ...
     * Sets source_group
     *
     * @param string $source_group Optionally specifies a common identifier for a group of fields in an envelope that should share a value.
     *
     * @return $this
     */
     ...
     * Sets fixed_text
     *
     * @param string $fixed_text Specifies the text contents for the field for fields with a &apos;FieldType&apos; of &apos;Typed&apos; and an &apos;InputType&apos; of &apos;Fixed&apos;.  Note: content may include merge fields.
     *
     * @return $this
     */
     ...
     * Sets timing
     *
     * @param string $timing Specifies the timing for when the contents of the field will be rendered to the containing document for fields with a &apos;FieldType&apos; of &apos;Typed&apos; and an &apos;InputType&apos; of &apos;Fixed&apos;.
     *
     * @return $this
     */
     ...
     * Gets options
     *
     * @return \Nmusco\AssureSign\v3\Model\FieldOption[]
     */
     ...
     * Sets options
     *
     * @param \Nmusco\AssureSign\v3\Model\FieldOption[] $options Provides the list of options to present to the signer for fields with a &apos;FieldType&apos; of &apos;Typed&apos; and one of the &apos;Multiple Choice&apos; signatory input types.
     *
     * @return $this
     */
     ...
     * Sets pen_color
     *
     * @param string $pen_color Specifies the color of &apos;ink&apos; used to render the signature for fields with a &apos;FieldType&apos; of &apos;Signature&apos;.
     *
     * @return $this
     */
     ...
     *
     * @param int $signatory_input_type Specifies the type of input required from the signer for fields with a &apos;FieldType&apos; of &apos;Typed&apos;.  Possible values include: Free_Text = 0, Prefill = 1, Multiple_Choice_Text = 2, Multiple_Choice_Graphic = 3, Timestamp = 4, Custom_Validation = 5, Multiple_Choice_Radio = 6, Multiple_Choice_Checkbox = 7
     *
     * @return $this
     */
     ...
     * Sets signature_type
     *
     * @param string $signature_type Specifies the type of signature (initials or signature) the signer will be prompted to provide for fields with a &apos;FieldType&apos; of &apos;Signature&apos;.
     *
     * @return $this
     */
     ...
     *
     * @param int $font_decoration Specifies the font styles that should be applied for fields with a &apos;FieldType&apos; of &apos;Typed&apos; as an integer representation of a bitwise operator.  For Example: Regular = 0, Bold = 1, Italic = 2, Underline = 4, Bold + Italic + Underline = 7
     *
     * @return $this
     */
     ...
     * Sets font_name
     *
     * @param string $font_name Specifies the name of the supported font that should be used to render the contents of the field for fields with a &apos;FieldType&apos; of &apos;Typed&apos;.
     *
     * @return $this
     */
     ...
     * Sets font_size
     *
     * @param int $font_size Specifies the size of the font that should be used to render the contents of the field for fields with a &apos;FieldType&apos; of &apos;Typed&apos;.  Possible values include: 6, 8, 10, 12, 14
     *
     * @return $this
     */
     ...
     *
     * @param string $horizontal_alignment Specifies the horizontal alignment of the field contents for fields with a &apos;FieldType&apos; of &apos;Typed&apos;.
     *
     * @return $this
     */
     ...
     *
     * @param string $vertical_alignment Specifies the vertical alignment of the field contents for fields with a &apos;FieldType&apos; of &apos;Typed&apos;.
     *
     * @return $this
     */
     ...
     * Sets word_wrap
     *
     * @param bool $word_wrap Specifies whether or not the contents of the field should be automatically wrapped to a new line for fields with a &apos;FieldType&apos; of &apos;Typed&apos;.
     *
     * @return $this
     */
     ...
     * Sets formatter_type
     *
     * @param string $formatter_type Specifies the text mask to apply for fields with a &apos;FieldType&apos; of &apos;Typed&apos;.
     *
     * @return $this
     */
     ...
     * Sets formatter_code
     *
     * @param string $formatter_code Specifies the custom text mask to apply for fields with a &apos;FieldType&apos; of &apos;Typed&apos; and a &apos;FormatterType&apos; of &apos;Fixed&apos;.
     *
     * @return $this
     */
