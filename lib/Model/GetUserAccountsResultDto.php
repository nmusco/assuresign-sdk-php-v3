...
class GetUserAccountsResultDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'getUserAccountsResultDto';
     ...
     * Gets user_accounts
     *
     * @return \Nmusco\AssureSign\v3\Model\UserAccount[]
     */
     ...
     * Sets user_accounts
     *
     * @param \Nmusco\AssureSign\v3\Model\UserAccount[] $user_accounts A list of the accounts to which the specified user has access.
     *
     * @return $this
     */
