...
class EmailNotificationV32 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'emailNotificationV3_2';
...
self::STAGE_ON_PAYMENT_REFUNDED,        ];
     ...
     * Sets body
     *
     * @param string $body Specifies the body of the email notification.  Note: content may include merge fields.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Specifies the name of the email notification.
     *
     * @return $this
     */
     ...
     * Sets subject
     *
     * @param string $subject Specifies the subject of the email notification.  Note: content may include merge fields.
     *
     * @return $this
     */
