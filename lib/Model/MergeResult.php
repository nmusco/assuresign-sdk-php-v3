...
class MergeResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'mergeResult';
...
'trace' => 'getTrace'    ];
     ...
     * Sets result
     *
     * @param string $result Provides the resulting merged object.
     *
     * @return $this
     */
     ...
     * Sets trace
     *
     * @param string $trace Provides a list of the merge operations that were applied to the object.
     *
     * @return $this
     */
